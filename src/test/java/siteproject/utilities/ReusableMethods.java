...
//   waitFor(5);  => waits for 5 second => Thread.sleep(5000)
    ...
    // LOGIN METHOD
    public static void loginSpending() {
        ...
        spendingGoodHomePage.singIn.click();
        spendingGoodHomePage.spending_good_username.sendKeys(ConfigReader.getProperty("kullanici_username"));
        spendingGoodHomePage.spending_good_password.sendKeys(ConfigReader.getProperty("kullanici_password"));
        spendingGoodHomePage.loginButton.click();
    }
}
